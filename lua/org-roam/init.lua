...
local function org_roam_node_find()
    ...
    nodes = {
      {
        ...
        file =
        "/Users/cary/Library/Mobile Documents/com~apple~CloudDocs/Plain Org/zettelkasten/fleeting/How_to_learn_English_20240107210714.org",
      ...
      },
      {
        ...
        file =
        "/Users/cary/Library/Mobile Documents/com~apple~CloudDocs/Plain Org/zettelkasten/fleeting/Go_to_canada_20240107210453.org",
  ...
  vim.g.data = vim.json.encode(orgRoamGraphData)
  vim.fn.UpdateGraphData(vim.json.encode(orgRoamGraphData))
